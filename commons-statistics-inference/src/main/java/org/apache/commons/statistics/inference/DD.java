...
final class DD {
    ...
    private static long computePowScaled(long exp, double x, double xx, int n, DD f) {
        ...
        for (int i = 32 - shift; i != 0; i--, bits <<= 1) {
            ...
            a2l = f2 - a2h;
            p00 = f0 * f0;
            q00 = squareLowUnscaled(a0h, a0l, p00);
            p01 = f0 * f1;
            q01 = productLowUnscaled(a0h, a0l, a1h, a1l, p01);
            p02 = f0 * f2;
            q02 = productLowUnscaled(a0h, a0l, a2h, a2l, p02);
            p11 = f1 * f1;
            q11 = squareLowUnscaled(a1h, a1l, p11);
            p12 = f1 * f2;
            s0 = p00;
            // Sum (2 * p01, q00) -> (s1, r2)                  Order(eps)
            s1 = 2 * p01 + q00;
            r2 = twoSumLow(2 * p01, q00, s1);
            // Sum (2 * p02, 2 * q01, p11, r2) -> (s2, r3b)    Order(eps^2)
            s2 = p02 + q01;
            r3b = twoSumLow(p02, q01, s2);
            u = p11 + r2;
            v = twoSumLow(p11, r2, u);
            fastAdd(2 * s2, 2 * r3b, u, v, f);
            s2 = f.hi;
            r3b = f.lo;
            // Sum (2 * p12, 2 * q02, q11, r3b) -> s3          Order(eps^3)
            s3 = 2 * (p12 + q02) + q11 + r3b;
            ...
            if (bits < 0) {
                ...
                p10 = f1 * b0;
                q10 = productLowUnscaled(a1h, a1l, b0h, b0l, p10);
                p11 = f1 * b1;
                q11 = productLowUnscaled(a1h, a1l, b1h, b1l, p11);
                p20 = f2 * b0;
                q20 = productLowUnscaled(a2h, a2l, b0h, b0l, p20);
                p21 = f2 * b1;
                s0 = p00;
                // Sum (p01, p10, q00) -> (s1, r2, r3a)            Order(eps)
                u = p01 + p10;
                ...
                s1 = q00 + u;
                w = twoSumLow(q00, u, s1);
                r2 = v + w;
                r3a = twoSumLow(v, w, r2);
                // Sum (p11, p20, q01, q10, r2) -> (s2, r3b)       Order(eps^2)
                s2 = p11 + p20;
    ...
    private static double norm3(double s0, double s1, double s2, double s3, DD s12) {
        ...
        double g2 = q + s3;
        double g3 = fastTwoSumLow(q, s3, g2);
    ...
    private static double multiply3(double a0, double a1, double a2, double b, DD s12) {
        ...
        double a0h = highPartUnscaled(a0);
        double a0l = a0 - a0h;
        double a1h = highPartUnscaled(a1);
        double a1l = a1 - a1h;
        double b0h = highPartUnscaled(b);
        double b0l = b - b0h;
        double p00 = a0 * b;
        double q00 = productLowUnscaled(a0h, a0l, b0h, b0l, p00);
        double p10 = a1 * b;
        double q10 = productLowUnscaled(a1h, a1l, b0h, b0l, p10);
        double p20 = a2 * b;
        // Sum (p10, q00) -> (s1, r1)            Order(eps)
        double s1 = p10 + q00;
        double r1 = twoSumLow(p10, q00, s1);
        // Sum (p20, q10, r1) -> (s2, s3)        Order(eps^2)
        double u = p20 + q10;
        double v = twoSumLow(p20, q10, u);
        double s2 = u + r1;
        u = twoSumLow(u, r1, s2);
