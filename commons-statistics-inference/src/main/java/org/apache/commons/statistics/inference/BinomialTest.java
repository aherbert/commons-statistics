...
public final class BinomialTest {
     ...
     */
    public static SignificanceResult test(int numberOfTrials, int numberOfSuccesses, double probability,
        ...
        double p;
        if (alternativeHypothesis == AlternativeHypothesis.GREATER_THAN) {
            p = distribution.survivalProbability(numberOfSuccesses - 1);
        } else if (alternativeHypothesis == AlternativeHypothesis.LESS_THAN) {
