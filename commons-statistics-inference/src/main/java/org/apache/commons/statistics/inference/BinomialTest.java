 ...
 *
 * <p>Exact test for the statistical significance of deviations from a
...
public class BinomialTest {
     ...
     * binomial test about the probability of success \( \pi \).
     *
     ...
     * and 1; {@code numberOfTrials < numberOfSuccesses}; or if
     * {@code alternateHypothesis} is null.
    ...
    public double binomialTest(int numberOfTrials, int numberOfSuccesses, double probability,
        ...
        InferenceUtils.checkNonNegative(numberOfSuccesses);
        ...
        Objects.requireNonNull(alternativeHypothesis, "alternativeHypothesis");
        ...
        case TWO_SIDED:
            return twoSidedBinomialTest(numberOfTrials, numberOfSuccesses, probability, distribution);
        default:
            // All alternativeHypothesis values should be handled
     ...
     * @throws IllegalArgumentException if {@code numberOfTrials} or
     * {@code numberOfSuccesses} is negative; {@code probability} is not between 0
     * and 1; {@code numberOfTrials < numberOfSuccesses};
     * {@code alternateHypothesis} is null; or {@code alpha} is not in the range {@code (0, 0.5]}
     * @see #binomialTest(int, int, double, AlternativeHypothesis)
     * @see AlternativeHypothesis
     */
    public boolean binomialTest(int numberOfTrials, int numberOfSuccesses, double probability,
        ...
        final double pValue = binomialTest(numberOfTrials, numberOfSuccesses, probability, alternativeHypothesis);
        return pValue < alpha;
    }
}
