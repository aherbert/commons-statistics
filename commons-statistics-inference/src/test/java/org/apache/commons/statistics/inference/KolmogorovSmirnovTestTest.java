...
class KolmogorovSmirnovTestTest {
    ...
    static Stream<Arguments> testTwoSample() {
        ...
        builder.add(Arguments.of(
                ...
                new double[] {1, 2},
                new double[] {0, 0, 0},
                new double[] {1, 0.6666666666666666, 0.6666666666666666}, 0, PValueMethod.EXACT, true));
        ...
        builder.add(Arguments.of(
                ...
                new double[] {0.9444444444444444, 0.48567178524771226, 0.4856717852477124}, 1e-15, PValueMethod.ASYMPTOTIC, false));
        builder.add(Arguments.of(
                new double[] {1, 2, 2, 2, 3},
                new double[] {2, 2, 4},
                new double[] {1 / 3.0, 1 / 3.0, 0},
                new double[] {0.9444444444444444, 0.48567178524771226, 1}, 1e-15, PValueMethod.ASYMPTOTIC, false));
        builder.add(Arguments.of(
                new double[] {1, 2, 2, 5, 6},
                new double[] {0, 2, 2, 3, 3, 3},
                new double[] {0.4, 0.1, 0.4},
                new double[] {0.5946666666666665, 0.8594048608885093, 0.28348216705243917}, 1e-15, PValueMethod.ASYMPTOTIC, false));
        // Auto chooses exact even in the presence of ties.
        builder.add(Arguments.of(
                new double[] {1, 2, 2, 2, 3},
                new double[] {0, 2, 4},
                new double[] {1 / 3.0, 1 / 3.0, 1 / 3.0},
                new double[] {0.9642857142857143, 0.5892857142857143, 0.5892857142857143}, 1e-15, PValueMethod.EXACT, false));
        builder.add(Arguments.of(
                new double[] {1, 2, 2, 2, 3},
                new double[] {2, 2, 4},
                new double[] {1 / 3.0, 1 / 3.0, 0},
                new double[] {0.9642857142857143, 0.5892857142857143, 1}, 1e-15, PValueMethod.EXACT, false));
        builder.add(Arguments.of(
                new double[] {1, 2, 2, 5, 6},
                new double[] {0, 2, 2, 3, 3, 3},
                new double[] {0.4, 0.1, 0.4},
                new double[] {0.6883116883116883, 0.8571428571428571, 0.35714285714285715}, 1e-15, PValueMethod.EXACT, false));
        return builder.build();
    }
