 ...
 *
 * <p>Specialisations are provided for a low number of indices or ranges of indices.
...
final class RangePredicates {
    ...
    /**
     * Test if the range  {@code [left, right]} overlaps {@code [k1, k2]}.
     *
     * <p>Assumes {@code k1 <= k2}.
     *
     * @param left Index.
     * @param right Index.
     * @param k1 Index.
     ...
     */
    static boolean overlap(int left, int right, int k1, int k2) {
        // Overlap:
        // L-----------R
        // ......... K1---------K2
        // --K2
    ...
    // TODO
    // More specialisations for indices up to 10 ???
    // 5 * range; or 10 points; both support short circuiting.
