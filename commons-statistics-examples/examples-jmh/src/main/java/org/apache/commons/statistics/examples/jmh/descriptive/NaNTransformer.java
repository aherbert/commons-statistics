...
interface NaNTransformer {
     ...
     * <li>The bounds of the array containing data to partition, i.e. the range
     * of unsorted data in the array to partition. This is {@code from} inclusive and
     * {@code to} exclusive.
     * <li>The {@code size} of the data; this can be smaller than the input array length if
     * the transformer is configured to ignore NaN values.
     * </ul>
     *
     * @param data Data.
     * @param bounds [from, to, size]
