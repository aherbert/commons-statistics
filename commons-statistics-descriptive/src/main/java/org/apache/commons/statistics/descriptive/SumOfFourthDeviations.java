 ...
 * is the asymmetrical index where \( g * N \) is the sum of cubed deviations from the mean.
 * Note the term \( ({g_1} - {g_2}) N_1 N_2 == (sc_1 * N_2 - sc_2 * N_1 \)
 * where \( sc \) is the sum of cubed deviations.
 *
 ...
 * cubed deviations. This updating formula is identical to that used in
...
class SumOfFourthDeviations extends SumOfCubedDeviations {
    ...
    /**
     * Returns a {@code SumOfFourthDeviations} instance of all input values, or {@code NaN}
     * if:
     * <ul>
     ...
     *     <li>the sum of the cubed deviations from the mean is infinite</li>
     * </ul>
     *
     * <p>Note: {@code SumOfFourthDeviations} computed using
    ...
    public void accept(double value) {
        ...
        // Require current g * N == sum-of-cubed deviations
    ...
    double getSumOfFourthDeviations() {
        // XXX: Possibly change to consolidate any non-finite Sq to NaN
