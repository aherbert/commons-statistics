...
class SumOfCubedDeviations extends SumOfSquaredDeviations {
    ...
    /**
     * Returns a {@code SumOfCubedDeviations} instance of all input values, or {@code NaN}
     * if:
     * <ul>
     ...
     * </ul>
     *
     * <p>Note: {@code SumOfCubedDeviations} computed using
    ...
    static SumOfCubedDeviations of(double... values) {
        ...
        final double sc = computeSumOfCubedDeviations(xbar, values);
        return new SumOfCubedDeviations(sc, ss);
    }

    /**
     * Compute the sum of cubed deviations.
     * This method is reused in higher order deviations.
     *
     * @param xbar Sample mean (must be finite).
     * @param values Values.
     * @return sum of cubed deviations
     */
    private static double computeSumOfCubedDeviations(double xbar, double[] values) {
    ...
    double getSumOfCubedDeviations() {
        // XXX: Possibly change to consolidate any non-finite SC to NaN
