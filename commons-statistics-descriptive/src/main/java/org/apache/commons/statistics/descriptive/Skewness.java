...
public final class Skewness implements DoubleStatistic, DoubleStatisticAccumulator<Skewness> {
    ...
    /**
     * Creates a {@code Skewness} instance.
     *
    ...
    /**
     * Returns a {@code Skewness} instance that has the skewness of all input values, or {@code NaN}
     * if the input array is empty.
     *
     * <p>Note: {@code Skewness} computed using {@link #accept(double) accept} may be different
     * from this skewness.
     *
     * <p>See {@link Skewness} for details on the computing algorithm.
     *
     * @param values Values.
     * @return {@code Skewness} instance.
     */
