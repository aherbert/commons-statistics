...
public final class Kurtosis implements DoubleStatistic, DoubleStatisticAccumulator<Kurtosis> {
    ...
    /**
     * Creates a {@code Kurtosis} instance.
     *
    ...
    /**
     * Returns a {@code Kurtosis} instance that has the kurtosis of all input values, or {@code NaN}
     * if the input array is empty.
     *
     * <p>Note: {@code Kurtosis} computed using {@link #accept(double) accept} may be different
     * from this kurtosis.
     *
     * <p>See {@link Kurtosis} for details on the computing algorithm.
     *
     * @param values Values.
     * @return {@code Kurtosis} instance.
     */
